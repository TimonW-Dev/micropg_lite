...
micropg_lite is a micropython PostgreSQL database driver made for microchips specifically for ESP8266 and other microchips that are low on RAM.
...
If there are problems or questions, open an issue on [github.com](https://github.com/TimonW-Dev/micropg_lite).
